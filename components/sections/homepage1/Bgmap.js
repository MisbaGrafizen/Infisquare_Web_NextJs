            ...
            <div className="section bg-map d-block">
                <div className="container">
                    <div className="box-map">
                        ...
                        <div className="map-info"><img className="mb-25 wow animate__animated animate__fadeIn" style={{width:"140px", marginLeft:"70px"}} src="/assets/imgs/template/logo.webp" alt="transp" />
