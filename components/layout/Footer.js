                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-3 width-23 mb-30">
                                <div className="mb-20"><img src="/assets/imgs/template/logo-footer.webp" alt="transp" /></div>
                    ...
                    <div className="container">
                        <div className="footer-bottom">
                            <div className="row align-items-center">
                                <div className="col-lg-6 col-md-12 text-center text-lg-start"><span className="color-grey-300 font-md">© Design and develop with ❤️ by Grafizen LLC {new Date().getFullYear()}</span></div>
