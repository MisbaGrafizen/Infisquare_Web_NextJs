        ...
        <>
            <Layout>
                ...
                <section className="section pt-85 bg-worldmap">
                    <div className="container">
                        <div className="text-start"><img className="mb-15 wow animate__animated animate__fadeIn" style={{width:'70px'}}  src="/assets/imgs/template/icons/favicon.webp" alt="transp" />
