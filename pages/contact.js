                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-xl-4 col-lg-5 position-relative">
                                    <div className="box-contactform-right">
                                        ...
                                        <div className="map-info"><img className="mb-25 wow animate__animated animate__fadeIn"  style={{width:"100px"}} src="/assets/imgs/template/logo.webp" alt="transp" />
                                            <p className="color-grey-700 mb-25 wow animate__animated animate__fadeIn">102, Sanskar Apartment Opp. Atithi Restaurant, 150 Ft Road , Rajkot, Gujarat, - 360005.</p>
                                            ...
                                            <p className="color-grey-700 mb-30 wow animate__animated animate__fadeIn">
                                                ...
                                                </svg>Email: admin@infisquare.com
                                            </p>
                            ...
                            <div className="col-xl-3 col-md-6 mb-50">
                                <div className="cardService">
                                    ...
                                    <div className="cardInfo wow animate__animated animate__fadeIn"><img src="/assets/imgs/page/homepage1/delivery.png" alt="transp" />
                                        ...
                                        <p className="font-xs color-grey-900"><strong className="color-brand-2">Email:</strong>admin@infisquare.com</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-3 col-md-6 mb-50">
